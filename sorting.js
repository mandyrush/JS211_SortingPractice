    ...
    const stringsToNumbs = (numbers) => {
            // Loop over each item in the given array and convert the item to a number
            const numArray = numbers.map(string => {
                return parseInt(string);
            });
            return numArray;
    }
    console.log('Number Array: ', stringsToNumbs(strNums));
